...
| 系統 | 主なテーブル | ファイル |
|------|------------|---------|
| 認証・アカウント系<br>プレイヤー・キャラクター系 | User / RefreshToken / EmailVerificationToken / Player / PlayerSettings / Character / PartyMember / SkillMaster / LearnedSkill / TowerClearRecord / PrestigeBonus | [er_diagram/player.md](er_diagram/player.md) |
| 装備・アイテム系<br>ショップ・施設系 | Equipment / CharacterEquipSlot / InventoryItem / ItemMaster / ShopDailyState / ShopDailySlot / Facility | [er_diagram/item.md](er_diagram/item.md) |
