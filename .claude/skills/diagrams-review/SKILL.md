...
| 4 | `.claude/project/review/diagrams.md` | パラメータ（§0）・観点（§1）・重要度の基準（§2） |
| 5 | `.claude/project/basic-design.md` | 対象の図一覧と照合先（§1）・Mermaid の機械検証（§4） |
...
|------|------|
| なし | **差分モード**（既定） |
| `full` | 全量モード（分担・体数はプロファイル §0「全量モードの分担」に従う） |
