...
| 分冊 | 担当節 |
|------|-------|
| [integration-test/conventions.md](integration-test/conventions.md) | §1.1 L1 の記述規約 / §1.2 L2 の記述規約（**テストを書くときに読む**） |
...
マーカー・実行コマンド・ファイル分割・乱数／時刻の扱い・セレクタ規約は [conventions.md](integration-test/conventions.md) §1.1・§1.2。
