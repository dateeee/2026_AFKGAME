...
| [docs/tech/tech_spec.md](docs/tech/tech_spec.md) | `tech/tech_*.md` — data / structure / api / architecture / logging（非機能: performance / security / operations、詳細設計: battle / offline / tick / polling / state / rng / numeric / shop / design_system、認証: auth） |
