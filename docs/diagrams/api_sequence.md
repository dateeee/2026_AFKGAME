...
> API定義: [tech_api.md](../tech/basic/tech_api.md) / ゲームループ: [tech_architecture.md](../tech/basic/tech_architecture.md)
...
| 6.5. パーティ編成<br>7. スキル習得・リセット<br>8. 限界突破 | パーティ・スキル・限界突破（Phase 3〜4） | [api_sequence/character.md](api_sequence/character.md) |
