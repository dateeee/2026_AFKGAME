...
> ただし**難易度パラメータの受け渡し方法（`/api/tower/select` への追加パラメータかキー体系か）は未確定**で、Phase 5 の基本設計で確定する（[open_specs.md](../../open_specs.md) #3、正は [tech_api.md](../../tech/basic/tech_api.md)「イベントダンジョン」）。
