...
- 限界突破（同キャラ重複時。重複は酒場ガチャで生じるため Phase 4 から）
...
Phase 1〜5 の仕様は確定済み。未確定が生じた場合は `docs/backlog/open_specs.md`、数値のみ未定の項目は [balance_backlog.md](../backlog/balance_backlog.md) で管理する。
