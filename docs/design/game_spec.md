...
- **ダンジョン3「極地のダンジョン」（塔6〜8）**

### Phase 5 — エンドコンテンツ・拡張
- **ダンジョン4「終焉のダンジョン」（塔9〜10）**
- ボスラッシュ（無限ウェーブ、制限なし、サーバーランキング）
- 転生（プレステージ）システム（キャラクター個別転生、転生ポイント）
- イベントダンジョン（常設、固定難易度3段階）
- 深淵の塔（無限塔、指数スケーリング、LV155〜9999 の常設放置コンテンツ）。**同Phase内の塔10「天空の塔」クリアで解放される**

### 塔の実装Phase対応

| Phase | 追加される塔 | ダンジョン |
|-------|------------|-----------|
| 1 | 塔1 ゴブリンの塔 | 1 始まりのダンジョン |
...
各塔の階層数・推奨LV・環境効果は [systems/dungeon.md](systems/dungeon.md) を参照。
...
未確定の項目は [open_specs.md](../open_specs.md)、数値のみ未定の項目は [balance_backlog.md](../balance_backlog.md) で管理する。
