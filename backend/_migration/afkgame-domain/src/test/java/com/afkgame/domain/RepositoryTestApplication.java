...
/**
 * Repository 統合テスト用の最小 Spring コンテキスト。
 *
 ...
 *
 * <p>{@code @MapperScan} は MyBatis3 のアノテーション名で、走査対象は
 * {@code com.afkgame.domain.repository} の Repository インタフェース
 * （MyBatis3 が Mapper インタフェースの仕組みで実装を生成する。
 * docs/process/coding_standards_backend/layering.md §3）。
 *
